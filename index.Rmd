...
leaflet(width = "100%") %>%
  ...
  addAwesomeMarkers(lng=-84.39286516206292, lat=42.76133288367064,
                    icon=awesomeIcons(
                      icon = 'fa-solid fa-fire',
                      library = 'fa',
                      iconColor = 'black',
                      markerColor = 'orange'), 
                    popup="<b>Friday bonfire</b><br>Lake Lansing<br><a href='https://goo.gl/maps/jp2YRKHiKwpuMvYi7'>View in Google Maps</a>")
